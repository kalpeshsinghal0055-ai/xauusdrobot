      ...
      <nav className="container flex items-center justify-between h-16 lg:h-20">
        ...
        <div className="hidden lg:flex items-center gap-6 xl:gap-8">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-5 py-2.5 bg-gradient-to-r from-gold-dark via-gold to-gold-light text-background font-semibold text-sm rounded tracking-wide hover:shadow-lg hover:border-gold/20 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shrink-0"
          >
            GET FREE EA
          </a>
        </div>
