...
const steps = [
  {
    ...
    desc: "Register a live trading account with one of our recommended brokers — Markets4you, Exness, Vantage or XS — using our affiliate link. Takes less than 5 minutes. Low minimum deposit starting at $10.",
