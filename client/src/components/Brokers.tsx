          ...
          {brokers.map((broker, i) => (
            ...
            >
              ...
              <a
                ...
                className="block w-full text-center px-6 py-3.5 bg-gradient-to-r from-gold-dark via-gold to-gold-light text-background font-bold text-sm rounded hover:shadow-lg hover:shadow-gold/20 transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] uppercase tracking-wide"
              >
                OPEN & GET FREE EA →
              </a>
            </motion.div>
